...
ayant des constantes diélectriques différentes, cela peut engendrer de
la radiation de transition sous forme de photons. Cet effet est
...
l'électron. Deux seuils sont alors défini: un seuil bas, pour mesurer
la position des particules charg\'ees et un seuil haut, pour
reconnaître les signaux provenant de la radiation de transition et optimisé
...
trace~\cite{olive_detectors_2014}. Ainsi, le détecteur PIXEL (avec IBL) donne
quatre mesures très précises, le SCT en rajoute 4 avec un peu moins de
...
Le détecteur ATLAS est donc complété par l'ajout de trois aimants toroïdaux
...
font une analyse plus détaillée pour déterminer si l'événement est
intéressant ou non.
