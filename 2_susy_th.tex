...
nouvelles particules sont les \emph{superpartenaires} des particules
du MS. Si La supersymétrie est une une symétrie exacte de la théorie,
...
peuvent être prédites et entrent dans le modèle comme
paramètres~\cite{olive_susy1_2014}.
...
lagrangien possède cette symétrie. Puisque cette symétrie, si elle
...
violation CP additionnelle introduite par le MSSM.
...
donc activement recherchés au LHC~\cite{ATLAS-CONF-2015-067}.
...
quatre \emph{charginos}, notés $\chi_{1,2}^\pm$ ainsi que ceux
...
hiérarchie soit réglé dans le MSSM~.
...
renormalisables. Or, il est possible d'inclure des interactions
violant la conservation de $B$ et $L$ dans une extension
supersymétrique du MS. Pour que la théorie soit viable, il faut donc
...
MS, et toutes particule supersymétrique doit éventuellement se
